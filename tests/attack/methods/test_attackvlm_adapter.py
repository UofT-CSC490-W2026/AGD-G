...
def mock_vlm_dependencies():
    with patch("agdg.attack.methods.attackvlm_adapter.TextCLIPModel") as mock_text_clip, \
         patch("agdg.attack.methods.attackvlm_adapter.PatchTextCLIPModel") as mock_patch_clip, \
         patch("agdg.attack.methods.attackvlm_adapter.AttackVLMText") as mock_attack_vlm:
        yield {
