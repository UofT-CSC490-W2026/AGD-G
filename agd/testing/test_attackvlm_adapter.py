...
try:
    from attackvlm_adapter import AttackVLMTextAdapter, AttackResult
except ImportError:
    import sys
    import os
...
def mock_vlm_dependencies():
    with patch("attackvlm_adapter.TextCLIPModel") as mock_text_clip, \
         patch("attackvlm_adapter.PatchTextCLIPModel") as mock_patch_clip, \
         patch("attackvlm_adapter.AttackVLMText") as mock_attack_vlm:
        yield {
